      ...
      <view class="tn-flex tn-flex-wrap tn-padding-bottom">
        <view class="king-list tn-margin-top-sm">
          ...
          <view class="king-icon">
            <tn-icon name="trophy" class="tn-color-white tn-text-lg tn-bg-blue tn-round tn-padding-xs"></tn-icon>
               ...
               <view class="tn-margin-sm tn-padding-top-xs" style="width: 100%;">
                 ...
                 <view class="tn-flex tn-flex-row-between tn-flex-col-between">
                   ...
                   <view class="justify-content-item tn-color-gray tn-text-center tn-color-gray--disabled" style="padding-top: 5rpx;">
                     <!-- <tn-icon name="footprint" class="tn-padding-right-xs tn-text-lg"></tn-icon>
          ...
          <view class="king-icon">
            <tn-icon name="footprint" class="tn-color-white tn-text-lg tn-bg-blue tn-round tn-padding-xs"></tn-icon>
