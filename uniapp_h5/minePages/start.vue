  ...
  <view class="oa-content">
    ...
    <swiper class="card-swiper" :circular="true"
      ...
      <swiper-item v-for="(item,index) in swiperList" :key="index" :class="cardCur==index?'cur':''">
        ...
        <view class="swiper-item image-banner" :style="'background-image:url('+ item.url + ');background-color: '+ item.color +';background-size: cover;height: 100vh;width: 100vw;'">
        </view>
        <!-- <view class="swiper-item-png image-banner">
          <image :src="item.pngurl" mode="widthFix" v-if="item.type=='image'"></image>
        </view> -->
        <view class="swiper-item-png image-banner" :style="'background-image:url('+ item.pngurl + ');background-size: cover;height: 924rpx;width: 750rpx;'">
        </view>
    ...
    <view class="tn-flex tn-footerfixed tn-padding">
      <view class="tn-flex-1 justify-content-item tn-text-center">
        <tn-button
          ...
          shape="round"
          :plain="true"
          @click="tn('/minePages/login')"
        >
          <text class="">立即体验</text>
        </tn-button>
      </view>
    </view>
